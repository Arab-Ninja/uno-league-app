...
export const en: Dictionnaire = {
  ...
  home: {
    ...
    players: "Players",
    book: "Join the session",
    pay: "Pay for the session",
    open: "View the session",
    stats: "View the stats",
  ...
  invite: {
    ...
    close: "Close",
    inAppTitle: "A player in the app",
    searchPlaceholder: "Search a player by name",
    searchHint: "Type at least two letters of the name.",
    searching: "Searching…",
    noResult: "No player found.",
    inviteOne: "Invite",
    sending: "Sending…",
    invited: "Invited",
    stateParticipant: "Already in",
    stateOtherDivision: "Other division",
    stateReferee: "Referee",
    notifyNote:
      "The player gets a notification, and the invitation waits for them on their home screen.",
    or: "or",
    shareLink: "Share the link",
    shareHint: "WhatsApp, SMS… for those who don't have the app yet.",
