...
export const fr = {
  ...
  home: {
    hello: "Salut {name},",
    letsPlay: "On joue ?",
    balanceLabel: "Solde : {amount}. Ouvrir le portefeuille",
    nextMine: "Votre prochain match",
    nextOpen: "Prochain match ouvert",
    today: "Aujourd'hui",
    tomorrow: "Demain",
    inDays: "J-{count}",
    players: "Joueurs",
    book: "Rejoindre la session",
    pay: "Payer la session",
    open: "Voir la session",
    ...
    xpLeft: "{xp} XP restants",
    divisionName: "Division {n}",
    onBill: "À l'affiche",
    invitedTitle: "On vous invite",
    invitedBy: "Invitation de {name}",
  ...
  invite: {
    ...
    close: "Fermer",
    inAppTitle: "Un joueur de l'application",
    searchPlaceholder: "Rechercher un joueur par son nom",
    searchHint: "Tapez au moins deux lettres du nom.",
    searching: "Recherche…",
    noResult: "Aucun joueur trouvé.",
    inviteOne: "Inviter",
    sending: "Envoi…",
    invited: "Invité",
    stateParticipant: "Déjà inscrit",
    stateOtherDivision: "Autre division",
    stateReferee: "Arbitre",
    notifyNote:
      "Le joueur reçoit une notification, et l'invitation l'attend sur son accueil.",
    or: "ou",
    shareLink: "Partager le lien",
    shareHint: "WhatsApp, SMS… pour ceux qui n'ont pas encore l'application.",
  ...
  calendar: {
    ...
    filters: "Filtrer par lieu et par mode",
  ...
  admin: {
    ...
    audit: {
      divisionUpdate: "Changement de division",
      unoAdjust: "Ajustement de solde",
      profileUpdate: "Modification de profil",
      passwordChange: "Changement de mot de passe",
      itemCreate: "Création de produit",
      itemUpdate: "Modification de produit",
      itemArchive: "Archivage de produit",
      proposalCreate: "Création de session",
      proposalStatus: "Changement de statut de session",
      matchValidate: "Validation de match",
      orderCreate: "Commande",
      emptyTitle: "Aucune entrée d'audit",
      emptyBody: "Les modifications sensibles seront tracées ici.",
      system: "système",
      before: "Avant",
      after: "Après",
    },
    orders: {
      refunded: "Commande #{id} {status} — le joueur a été recrédité.",
      marked: "Commande #{id} marquée « {status} ».",
      all: "Toutes",
      emptyTitle: "Aucune commande",
    ...
    suggestions: {
      ...
      notePlaceholder: "Mot joint à la réponse (facultatif)",
      answerTo: "Réponse à « {title} »",
      accept: "Retenir",
      decline: "Écarter",
      answer: "Réponse : « {note} »",
    },
    events: {
      ...
      emptyTitle: "Aucun évènement",
      allRead: "Tout est lu.",
      emptyBody: "L'activité de la ligue apparaîtra ici.",
    ...
    charities: {
      added: "Association ajoutée.",
      updated: "Association mise à jour.",
      addTitle: "Ajouter une association",
      editTitle: "Modifier l'association #{id}",
    ...
    images: {
      ...
      imageN: "Image {n}",
      main: "Principale",
      removeN: "Retirer l'image {n}",
      leftN: "Déplacer l'image {n} vers la gauche",
      rightN: "Déplacer l'image {n} vers la droite",
      full: "Galerie complète",
      add: "Ajouter des images",
      pasteUrl: "…ou coller une URL https://",
      addUrl: "Ajouter",
    ...
    photo: {
      ...
      offset: "Cadrage vertical",
      offsetAria: "Ajuster le cadrage vertical de la photo",
      replace: "Remplacer",
    ...
    purge: {
      ...
      paid: "{count} réglé(s)",
      toRefund: " — {uno} UNO à rembourser",
      delete: "Supprimer",
      membersReleased: "{count} membre(s) libéré(s)",
      treasuryReturned: "{uno} UNO rendus au fondateur",
      challengesAnnulled: "{count} défi(s) annulé(s)",
      ...
      inTreasury: "{uno} UNO en caisse",
      locked: "{uno} UNO séquestrés",
      openChallenges: "{count} défi(s) en cours",
      dissolve: "Dissoudre",
      confirmDissolve: "Oui, dissoudre",
    },
    tournaments: {
      opened: "Format ouvert. Les clubs peuvent désormais y poser des dates.",
      updated: "Format mis à jour. Les tournois déjà posés gardent leurs prix.",
      cancelled: "Tournoi annulé : chaque club engagé a retrouvé son droit.",
      openTitle: "Ouvrir un format",
      ...
      withdrawn: "Retiré",
      tournaments: "Tournois",
      noTournament: "Aucun tournoi. Le premier s'ouvre au-dessus.",
      clubsCount: "{entries}/{size} clubs",
      cancelAndRefund: "Annuler et rendre les engagements",
      cancelledTitle: "Annulés",
    ...
    players: {
      ...
      supervisorOff: "Droit de supervision retiré.",
      amountInvalid: "Saisissez un montant entier positif.",
      reasonRequired: "Indiquez un motif (3 caractères minimum).",
      newBalance: "Nouveau solde : {uno} UNO.",
      allZeroAlready: "Tous les soldes étaient déjà à zéro.",
      ...
      debit: "Débiter (−)",
      reason: "Motif",
      reasonPlaceholder: "Journalisé dans l'audit",
    ...
    roster: {
      ...
      sizeOption: "{size} contre {size} ({total} inscrits)",
      ...
      move: "Déplacer la séance",
      newDate: "Nouvelle date",
      newSlot: "Nouveau créneau",
      confirmMove: "Confirmer le déplacement",
      signedUp: "{count}/{min} inscrits",
      paidOne: "{count} réglé",
      paidMany: "{count} réglés",
      filled: "{count} joueur(s) inscrit(s)",
      refused: " — {count} refusé(s) : {reason}",
      fill: "1. Compléter le plateau ({count} place(s))",
      settled: "{count} place(s) réglée(s)",
    ...
    bracket: {
      ...
      away: "l'équipe visiteuse",
      tied: "Score nul : désignez le club qualifié aux tirs au but.",
