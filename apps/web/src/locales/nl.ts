...
export const nl: Dictionnaire = {
  ...
  home: {
    hello: "Hoi {name},",
    letsPlay: "Spelen we?",
    balanceLabel: "Saldo: {amount}. Portemonnee openen",
    nextMine: "Je volgende wedstrijd",
    nextOpen: "Volgende open wedstrijd",
    today: "Vandaag",
    tomorrow: "Morgen",
    inDays: "Over {count} dagen",
    players: "Spelers",
    book: "Meedoen aan de sessie",
    pay: "Sessie betalen",
  ...
  invite: {
    sheetTitle: "Vrienden uitnodigen",
    close: "Sluiten",
    inAppTitle: "Een speler in de app",
    searchPlaceholder: "Zoek een speler op naam",
    searchHint: "Typ minstens twee letters van de naam.",
    searching: "Zoeken…",
    noResult: "Geen speler gevonden.",
    inviteOne: "Uitnodigen",
    sending: "Verzenden…",
    invited: "Uitgenodigd",
    stateParticipant: "Al ingeschreven",
    stateOtherDivision: "Andere divisie",
    stateReferee: "Scheidsrechter",
    notifyNote:
      "De speler krijgt een melding, en de uitnodiging wacht op zijn startscherm.",
    or: "of",
    shareLink: "Link delen",
    shareHint: "WhatsApp, sms… voor wie de app nog niet heeft.",
  ...
  calendar: {
    week: "Week",
    month: "Maand",
    viewLabel: "Kalenderweergave",
    previousWeek: "Vorige week",
    nextWeek: "Volgende week",
    filters: "Filteren op locatie en modus",
    seeWholeWeek: "Hele week bekijken",
    toPay: "Te betalen",
    title: "Kalender",
    all: "Alle",
  ...
  admin: {
    ...
    players: {
      ...
      supervisorOff: "Supervisierecht ingetrokken.",
      amountInvalid: "Vul een positief geheel bedrag in.",
      reasonRequired: "Geef een reden op (minstens 3 tekens).",
      newBalance: "Nieuw saldo: {uno} UNO.",
      allZeroAlready: "Alle saldi stonden al op nul.",
      ...
      debit: "Debiteren (−)",
      reason: "Reden",
      reasonPlaceholder: "Opgenomen in de audit",
      apply: "De aanpassing toepassen",
    ...
    roster: {
      ...
      date: "Datum",
      slot: "Tijdslot",
      teamSize: "Spelers per ploeg",
      sizeOption: "{size} tegen {size} ({total} inschrijvingen)",
      ...
      newSlot: "Nieuw tijdslot",
      confirmMove: "De verplaatsing bevestigen",
      signedUp: "{count}/{min} ingeschreven",
      paidOne: "{count} betaald",
      paidMany: "{count} betaald",
      filled: "{count} speler(s) ingeschreven",
      refused: " — {count} geweigerd: {reason}",
      fill: "1. De sessie aanvullen ({count} plaats(en))",
      settled: "{count} plaats(en) betaald",
    ...
    bracket: {
      ...
      home: "de thuisploeg",
      away: "de bezoekers",
      tied: "Gelijke stand: duid de club aan die na strafschoppen doorgaat.",
      record: "De uitslag opslaan",
      correct: "Verbeteren",
    },
  },
};
