 ...
 *
 * **Le titre de section appartient à ce composant**, et non à l'écran qui
 * l'appelle. Quand le serveur n'a pas de push configuré, tout disparaît d'un
 * bloc ; le laisser au-dessus laissait un intitulé « Notifications » suivi de
 * rien — ce qu'on lit comme une panne, pas comme une absence. Le cas se voit
 * dans l'application empaquetée, qui dépend de Firebase là où le navigateur
 * se contente des clés VAPID : le même compte affichait le réglage sur le
